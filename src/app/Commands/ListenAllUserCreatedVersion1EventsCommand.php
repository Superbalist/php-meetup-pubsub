...
class ListenAllUserCreatedVersion1EventsCommand implements CommandInterface
{
    /**
     * @var EventManager
     */
    ...
    public function run(array $options = [])
    {
        ...
        // the 'created' event and version 1
        $this->events->listen('events', 'user/created/1.0', function (SchemaEvent $event) {
